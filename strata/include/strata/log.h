...
__format_printf(3, 4) void StLog_Print(int level, const char *module_name, const char *fmt, ...);
__format_printf(3, 4) void StLog_IntSafePrint(
...
#define LOG(level, ...)         StLog_Print(level, MODULE_NAME, __VA_ARGS__)
#define ILOG(level, ...)        StLog_IntSafePrint(level, MODULE_NAME, __VA_ARGS__)
#define VLOG(level, fmt, args)  StLog_PrintValist(level, MODULE_NAME, fmt, args)
#define IVLOG(level, fmt, args) StLog_IntSafePrintValist(level, MODULE_NAME, fmt, args)
