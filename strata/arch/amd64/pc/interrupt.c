...
StStatus StIntP_Init(void)
{
    ...
    SET_INT_ENTRY(81); SET_INT_ENTRY(82); SET_INT_ENTRY(83);
    SET_INT_ENTRY(84); SET_INT_ENTRY(85); SET_INT_ENTRY(86); SET_INT_ENTRY(87);
    SET_INT_ENTRY(88); SET_INT_ENTRY(89); SET_INT_ENTRY(8a); SET_INT_ENTRY(8b);
    SET_INT_ENTRY(8c); SET_INT_ENTRY(8d); SET_INT_ENTRY(8e); SET_INT_ENTRY(8f);
    SET_INT_ENTRY(90); SET_INT_ENTRY(91); SET_INT_ENTRY(92); SET_INT_ENTRY(93);
    SET_INT_ENTRY(94); SET_INT_ENTRY(95); SET_INT_ENTRY(96); SET_INT_ENTRY(97);
    SET_INT_ENTRY(98); SET_INT_ENTRY(99); SET_INT_ENTRY(9a); SET_INT_ENTRY(9b);
    SET_INT_ENTRY(9c); SET_INT_ENTRY(9d); SET_INT_ENTRY(9e); SET_INT_ENTRY(9f);
    SET_INT_ENTRY(a0); SET_INT_ENTRY(a1); SET_INT_ENTRY(a2); SET_INT_ENTRY(a3);
    SET_INT_ENTRY(a4); SET_INT_ENTRY(a5); SET_INT_ENTRY(a6); SET_INT_ENTRY(a7);
    SET_INT_ENTRY(a8); SET_INT_ENTRY(a9); SET_INT_ENTRY(aa); SET_INT_ENTRY(ab);
    SET_INT_ENTRY(ac); SET_INT_ENTRY(ad); SET_INT_ENTRY(ae); SET_INT_ENTRY(af);
    SET_INT_ENTRY(b0); SET_INT_ENTRY(b1); SET_INT_ENTRY(b2); SET_INT_ENTRY(b3);
    SET_INT_ENTRY(b4); SET_INT_ENTRY(b5); SET_INT_ENTRY(b6); SET_INT_ENTRY(b7);
    SET_INT_ENTRY(b8); SET_INT_ENTRY(b9); SET_INT_ENTRY(ba); SET_INT_ENTRY(bb);
    SET_INT_ENTRY(bc); SET_INT_ENTRY(bd); SET_INT_ENTRY(be); SET_INT_ENTRY(bf);
    SET_INT_ENTRY(c0); SET_INT_ENTRY(c1); SET_INT_ENTRY(c2); SET_INT_ENTRY(c3);
    SET_INT_ENTRY(c4); SET_INT_ENTRY(c5); SET_INT_ENTRY(c6); SET_INT_ENTRY(c7);
    SET_INT_ENTRY(c8); SET_INT_ENTRY(c9); SET_INT_ENTRY(ca); SET_INT_ENTRY(cb);
    SET_INT_ENTRY(cc); SET_INT_ENTRY(cd); SET_INT_ENTRY(ce); SET_INT_ENTRY(cf);
    SET_INT_ENTRY(d0); SET_INT_ENTRY(d1); SET_INT_ENTRY(d2); SET_INT_ENTRY(d3);
    SET_INT_ENTRY(d4); SET_INT_ENTRY(d5); SET_INT_ENTRY(d6); SET_INT_ENTRY(d7);
    SET_INT_ENTRY(d8); SET_INT_ENTRY(d9); SET_INT_ENTRY(da); SET_INT_ENTRY(db);
    SET_INT_ENTRY(dc); SET_INT_ENTRY(dd); SET_INT_ENTRY(de); SET_INT_ENTRY(df);
    SET_INT_ENTRY(e0); SET_INT_ENTRY(e1); SET_INT_ENTRY(e2); SET_INT_ENTRY(e3);
    SET_INT_ENTRY(e4); SET_INT_ENTRY(e5); SET_INT_ENTRY(e6); SET_INT_ENTRY(e7);
    SET_INT_ENTRY(e8); SET_INT_ENTRY(e9); SET_INT_ENTRY(ea); SET_INT_ENTRY(eb);
    SET_INT_ENTRY(ec); SET_INT_ENTRY(ed); SET_INT_ENTRY(ee); SET_INT_ENTRY(ef);
    SET_INT_ENTRY(f0); SET_INT_ENTRY(f1); SET_INT_ENTRY(f2); SET_INT_ENTRY(f3);
    SET_INT_ENTRY(f4); SET_INT_ENTRY(f5); SET_INT_ENTRY(f6); SET_INT_ENTRY(f7);
    SET_INT_ENTRY(f8); SET_INT_ENTRY(f9); SET_INT_ENTRY(fa); SET_INT_ENTRY(fb);
    SET_INT_ENTRY(fc); SET_INT_ENTRY(fd); SET_INT_ENTRY(fe); SET_INT_ENTRY(ff);
