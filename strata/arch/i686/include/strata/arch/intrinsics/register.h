...
__always_inline uint32_t StA_ReadCr0(void)
{
    uint32_t value;
...
__always_inline void StA_WriteCr0(uint32_t value)
{
...
#define CR3_PFN_MASK 0xFFFFF000

__always_inline uint32_t StA_ReadCr3(void)
{
    uint32_t value;
...
__always_inline void StA_WriteCr3(uint32_t value)
{
...
__always_inline uint32_t StA_ReadCr4(void)
{
    uint32_t value;
...
__always_inline void StA_WriteCr4(uint32_t value)
{
    __asm__ volatile ("mov %0, %%cr4" : : "r"(value) : "memory");
}

#endif // __STRATA_ARCH_INTRINSICS_REGISTER_H__
