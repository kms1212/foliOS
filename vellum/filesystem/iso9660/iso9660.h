...
struct iso9660_dir_entry_extension_header {
    uint8_t identifier[2];
    uint8_t entry_len;
    uint8_t entry_ver;
} __packed;

struct iso9660_pathtbl_entry_header {
    uint8_t entry_len;
...
struct iso9660_vol_desc {
    ...
    union {
        ...
        struct {
            ...
            struct iso9660_dir_entry_header rootdir_entry_header;
            ...
            struct iso9660_time_longfmt time_created;
            struct iso9660_time_longfmt time_modified;
            struct iso9660_time_longfmt time_expired_after;
            struct iso9660_time_longfmt time_effective_after;
            uint8_t desc_ver;
...
struct rrip_px_entry {
    struct iso9660_dir_entry_extension_header header;
