#ifndef __VELLUM_ASM_INTRINSICS_CPUID_H__
#define __VELLUM_ASM_INTRINSICS_CPUID_H__
...
__always_inline void _ia32_cpuid(
...
#endif  // __VELLUM_ASM_INTRINSICS_CPUID_H__
