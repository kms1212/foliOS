...
VlStatus VlBiosP_ConnectApmRmInterface(void);
VlStatus VlBiosP_ConnectApmPm16Interface(
    void **entry,
...
VlStatus VlBiosP_ConnectPm32Interface(
    void **entry,
...
VlStatus VlBiosP_DisconnectApmInterface(void);
